...
2. (b) Core value check: The facilitator asks the proposer whether the proposal respects the rocket’s core values (see article I) by asking:
  * Is this proposal simple? Does it help us focus on the essential in order to develop ideas which make everyday life simpler?
  * Is this proposal human? Does it help us gain a deeper understanding of people so that we can enable them through technology to go beyond their current capabilities?
  * Is this proposal open? Does it nurture an open-minded culture where transparency, collaborative spirit and learning from failures create a fertile ground for passion and excellence?

    The proposer answers each of these three questions. If the proposer has to answer “no” to any of them, the proposal is considered invalid. The goal of this core value check is for the proposer to self-reflect whether the proposal is in line with our core values. The facilitator may judge only whether the proposer has made good faith to answer these questions. The facilitator may not judge the validity of the proposer’s arguments.

3. (c) Clarifying questions: Once the proposer makes a proposal, the other participants may ask clarifying questions to better understand the proposal or the tension behind it. The proposer may answer each question, or may decline to do so. The facilitator must disallow any reactions or opinions expressed about the proposal, and prevent discussion of any kind. Participants may also ask the interpreter to read the captured proposal or clarify any existing governance, whenever the process allows the participant to speak. The interpreter then does as requested.
